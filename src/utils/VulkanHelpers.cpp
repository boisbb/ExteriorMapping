...
{
    QueueFamilyIndices indices = vke::utils::findQueueFamilies(device, surface);
    ...
    {
        SwapChainSupportDetails swapChainSupport = vke::utils::querySwapChainSupport(device, surface);
